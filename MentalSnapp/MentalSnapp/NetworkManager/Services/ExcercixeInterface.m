...
- (void)getSubCategoryQuestionsExcerciseWithRequest:(ExcerciseRequest *)excerciseRequest andCompletionBlock:(completionBlock)block {
    _block = block;
    id apiInteractorProvider = [[APIInteractorProvider sharedInterface] getAPIInetractor];
    [apiInteractorProvider getSubCategoryQuestionsExcerciseWithRequest:excerciseRequest andCompletionBlock:^(BOOL success, id response) {
        [self parseSubCategoryQuestionsExcercise:response];
    }];
}
...
- (void)parseSubCategoryQuestionsExcercise:(id)response {
    ...
    if ([response isKindOfClass:[NSDictionary class]])
    {
        ...
        {
            NSError *error;
            NSArray *array = [response objectForKey:@"questions"];
            NSMutableArray *guidedExcercises = [[NSMutableArray alloc] init];
            for (NSDictionary *dictionary in array) {
                GuidedExcercise *excercise = [[GuidedExcercise alloc] initWithDictionary:dictionary error:&error];
                [guidedExcercises addObject:excercise];
